...
def main():
	...
	parser = argparse.ArgumentParser(
		...
		and calculates the Vina terms. Vina terms are calculated using the git repository(https://github.com/HongjianLi/RF-Score) \
		that implements rf-score v3."
		)
...
def check_file_format(protein_list, ligand_list):
	...
	for p, l in zip(protein_list, ligand_list):
		...
		if protein_file_format != "pdbqt" or ligand_file_format != "pdbqt":
			print(p,l)
			print(protein_file_format, ligand_file_format)
